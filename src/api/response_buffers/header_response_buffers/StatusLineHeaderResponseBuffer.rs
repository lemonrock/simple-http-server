...
impl StatusLineHeaderResponseBuffer
{
	...
	pub const Http11Ok: Self = Self::new(Http1MinorVersion::_1, 200);

	#[inline(always)]
	const fn new(http_1_minor_version: Http1MinorVersion, status_code: u16) -> Self
	{
		...
		(
			[
				b'H', b'T', b'T', b'P', b'/', b'1', b'.',http_1_minor_version as u8,
				b' ',
